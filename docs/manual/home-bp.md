...
2. ที่หน้าแรกของระบบให้คลิกปุ่ม **"เข้าสู่ระบบ"** บริเวณมุมขวาบน
    ![คำอธิบาย](../assets/home-page.png)

3. เลือกช่องทางการเข้าสู่ระบ:
    - **ThaiID** (กรมการปกครอง)
    - **MyMOPH** (กระทรวงสาธารณสุข)
    ![คำอธิบาย](../assets/login-page.png)
...
2. เลื่อนลงมาที่หัวข้อ**สิทธิ์การใช้งาน** เลื่อนสวิตช์เปิดที่กล่อง **"บันทึกข้อมูลการวัดความดันโลหิตที่บ้าน (Home BP)"** ให้เป็นสีเขียว
